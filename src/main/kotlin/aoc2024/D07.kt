 ...
 * --- Day 7: Bridge Repair ---
 *
 * The Historians take you to a familiar rope bridge over
 ...
 *
 * Operators are always evaluated left-to-right, not according
 * to precedence rules.
 * Furthermore, numbers in the equations cannot be rearranged.
 * Glancing into the jungle, you can see elephants holding two
 * different types of operators: add (+) and multiply (*).
 *
 * Only three of the above equations can be made true by
 * inserting operators:
 *
...
fun main() {
    val input =
        File("/Users/carlmonnera/Documents/dojo/kotlin/sandbox/src/main/kotlin/aoc2024/D07.txt").readText()
    println(d07sol1(input))
}

fun d07sol1(input: String): Int {
//  val (res, other) = testStr.split(':')
//  val values = other.trim().split(" ").map(String::toLong)
//  val mult = values.reduce { acc, i -> acc * i }

 ...
 * A, B, C, ..., Z. Each book has a code of at least 3 characters.
 * The 1st character of a code is a capital letter which defines the
 * book category.
 *
 ...
 *
 * Return the result as a string described in the example below, or
 * as a list of pairs (Haskell/Clojure/Racket/Prolog).
 *
 * If any of the input lists is empty, return an empty string,
 * or an empty array/list (Clojure/Racket/Prolog).
 *
 * Example
